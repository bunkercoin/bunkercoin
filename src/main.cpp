...
#if defined(NDEBUG)
# error "Bunkercoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Bunkercoin Signed Message:\n";
...
//TODO: this isn't identical to bunkercoin reference client.
...
static const int64_t nTargetTimespan = 4 * 60 * 60; // Bunkercoin: every 4 hours
static const int64_t nTargetTimespanNEW = 60 ; // Bunkercoin: every 1 minute
...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Bunkercoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool ConnectBlock(CBlock& block, CValidationState& state, CBlockIndex* pindex, CCoinsViewCache& view, bool fJustCheck)
{
    ...
    // BIP16 was always active in Bunkercoin
...
{
    // Bunkercoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
