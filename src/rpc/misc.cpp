...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"     (string, required) The bunkercoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"address\", (string) The bunkercoin address validated\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"BTaXouBvXCDfViRZzSCaVNQBAyt1D9zThT\"")
            + HelpExampleRpc("validateaddress", "\"BTaXouBvXCDfViRZzSCaVNQBAyt1D9zThT\"")
        );
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"BB1Y8APJPE9K1kfYeuGPcbtyK7uruTNFa9\\\",\\\"BB9yDzihrJJBZ7mEUuGRAz7bJbh5jQJexj\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"BB1Y8APJPE9K1kfYeuGPcbtyK7uruTNFa9\\\",\\\"BB9yDzihrJJBZ7mEUuGRAz7bJbh5jQJexj\\\"]\"")
        ;
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The bunkercoin address to use for the signature.\n"
...
UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw runtime_error(
            ...
            "bunkercoin-cli and the GUI. There is no server-side difference."
        );
