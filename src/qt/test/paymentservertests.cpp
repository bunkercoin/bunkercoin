...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Bunkercoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Bunkercoin (as there is no actual maximum coins)
