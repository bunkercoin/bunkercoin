...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MBKC);
    unitlist.append(kBKC);
    unitlist.append(BKC);
...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case MBKC: return QString("MBKC");
    case kBKC: return QString("kBKC");
    case BKC: return QString("BKC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case MBKC: return QString("Mega-Bunkercoin (1,000,000 BKC)");
    case kBKC: return QString("Kilo-Bunkercoin (1000 BKC)");
    case BKC: return QString("Bunkercoin");
...
qint64 BitcoinUnits::factor(int unit)
{
    switch(unit)
    {
    case MBKC: return Q_INT64_C(100000000000000);
    case kBKC: return Q_INT64_C(100000000000);
    case BKC:  return Q_INT64_C(100000000);
...
qint64 BitcoinUnits::maxAmount(int unit)
{
    switch(unit)
    {
    case MBKC: return Q_INT64_C(900000);
    case kBKC: return Q_INT64_C(900000000);
    case BKC:  return Q_INT64_C(900000000000);    //less than the coin supply until the year 2170
...
int BitcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
    case MBKC: return 6;  // 900,000 (# digits, without commas)
    case kBKC: return 9;  // 900,000,000
    case BKC:  return 12; // 900,000,000,000
