...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bunkercoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bunkercoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bunkercoin transaction") + "\n" +
              "  bunkercoin-tx [options] -create [commands]   " + _("Create hex-encoded bunkercoin transaction") + "\n" +
              "\n";
