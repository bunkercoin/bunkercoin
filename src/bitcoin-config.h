...
#define PACKAGE_BUGREPORT "info@bunkercoin.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bunkercoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bunkercoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bunkercoin"
