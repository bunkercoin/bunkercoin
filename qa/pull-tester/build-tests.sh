...
DISTDIR=bunkercoin-1.0.0

# Cross-compile for windows first (breaking the mingw/windows build is most common)
cd /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin
make distdir
mkdir -p win32-build
...
if [ -d "$OUT_DIR" -a -w "$OUT_DIR" ]; then
  set +e
  # Windows:
  cp /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/win32-build/src/bitcoind.exe $OUT_DIR/bitcoind.exe
  cp /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/win32-build/src/test/test_bitcoin.exe $OUT_DIR/test_bitcoin.exe
  cp /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/win32-build/src/qt/bitcoind-qt.exe $OUT_DIR/bitcoin-qt.exe
  # Linux:
  cp /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/linux-build/src/bitcoind $OUT_DIR/bitcoind
  cp /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/linux-build/src/test/test_bitcoin $OUT_DIR/test_bitcoin
  cp /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/linux-build/src/qt/bitcoind-qt $OUT_DIR/bitcoin-qt
  set -e
fi

# Run unit tests and blockchain-tester on Linux:
cd /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/linux-build
make check

# Run RPC integration test on Linux:
/media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/qa/rpc-tests/wallet.sh /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/linux-build/src

if [ $RUN_EXPENSIVE_TESTS = 1 ]; then
  # Run unit tests and blockchain-tester on Windows:
  cd /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/win32-build
  make check
fi
