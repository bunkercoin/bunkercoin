# Contributing to Bunkercoin Core

Bunkercoin Core is open source software, and we would welcome contributions
which improve the state of the software. For those wanting to discuss changes,
or look for work that needs doing, please see:

* [Help requests](https://github.com/bunkercoin/bunkercoin/labels/help%20wanted)
* [Bunkercoin on reddit](https://www.reddit.com/r/bunkercoin/)

## Branch Strategy

Bunkercoin Core's default branch is intentionally a stable release, so that anyone
...
1.15 branch is named `1.15-dev`. When raising PRs, please raise against the
...
Bunkercoin Core is a direct fork of Bitcoin Core and therefore benefits from as
...
[bitcoin/bitcoin](https://github.com/bitcoin/bitcoin) and future Bunkercoin Core
releases will automatically benefit from these.

When refactoring Bunkercoin-specific code, please keep refactoring requests
short, low complexity and easy to verify.


## "Decision Making" Process

The following applies to code changes to Bunkercoin Core, and is not to be
confused with overall Bunkercoin Network Protocol consensus changes. All consensus
...
Whether a pull request is merged into Bunkercoin Core rests with the repository
maintainers.

Maintainers will take into consideration if a patch is in line with the general
principles of Bunkercoin; meets the minimum standards for inclusion; and will
...
that have demonstrated a deeper commitment and understanding towards Bunkercoin
(over time) or have clear domain expertise may naturally have more weight, as
one would expect in all walks of life.

Where a patch set proposes to change the Bunkercoin consensus, it must have been
