...
pkgdatadir = $(datadir)/bunkercoin
pkgincludedir = $(includedir)/bunkercoin
pkglibdir = $(libdir)/bunkercoin
pkglibexecdir = $(libexecdir)/bunkercoin
...
am__aclocal_m4_deps = $(top_srcdir)/src/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/src/m4/bunkercoin_find_bdb51.m4 \
...
ACLOCAL = ${SHELL} /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/src/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/src/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/src/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/src/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
...
MAINT = 
MAKEINFO = ${SHELL} /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/src/build-aux/missing makeinfo
MAKENSIS = 
MKDIR_P = /bin/mkdir -p
MOC = /usr/bin/moc-qt4
...
OBJEXT = o
PACKAGE = bunkercoin
PACKAGE_BUGREPORT = info@bunkercoin.com
PACKAGE_NAME = Bunkercoin Core
PACKAGE_STRING = Bunkercoin Core 1.0.0
PACKAGE_TARNAME = bunkercoin
PACKAGE_URL = 
...
abs_builddir = /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin
abs_srcdir = /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin
abs_top_builddir = /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin
abs_top_srcdir = /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /media/matthew/21ce0322-964c-4b9e-91cf-da0ba45b4dbd/home/idotmaster/bunkercoin/src/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/bunkercoind$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/bunkercoin-qt$(EXEEXT)
BITCOIN_CLI_BIN = $(top_builddir)/src/bunkercoin-cli$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = Bunkercoin-Qt.app
OSX_DMG = Bunkercoin-Qt.dmg
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/Bunkercoin-Qt
...
$(OSX_APP)/Contents/MacOS/Bunkercoin-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_bunkercoin -o $@
