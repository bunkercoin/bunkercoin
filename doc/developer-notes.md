...
Run with the -testnet option to run with "play bunkers" on the test network, if you
...
- BunkercoinMiner : Generates bunkers (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:bunkercoin-project/bunkercoin.git
