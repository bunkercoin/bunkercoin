### Building bunkercoin-qt 1.1 on modern macs. ###

Note that this requires changes made by michilumin on the 1.1-dev branch as well as some changes to BDB.
...
### Clone bunkercoin locally, or check it out, etc. ###

For this purpose, just indicating the 1.1-branding branch in my repo.

	$git clone -b 1.1-branding --single-branch https://github.com/michilumin/dogecoin.git
...
### Go back to your Bunkercoin repo ###
