UNIX BUILD NOTES
====================
Some notes on how to build Bunkercoin in Unix. 
...
This will build bunkercoin-qt as well if the dependencies are met.
...
- Currently there are issues with newer libssl-dev and boost packages. We made a nice script to compile older versions of boost and libssl-dev so you dont have too [here!](compilepackages.sh)

Dependencies for the GUI: Ubuntu & Debian
-----------------------------------------

If you want to build Bunkercoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a bunkercoin-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip bunkercoind" to strip the debug
